...
export class TokenDto extends S.Class<TokenDto>("TokenDto")({
  ...
  "coinGeckoId": S.optionalWith(S.String, { nullable: true }),
  "logoURI": S.optionalWith(S.String, { nullable: true }),
  "isPoints": S.optionalWith(S.Boolean, { nullable: true }),
  "feeConfigurationId": S.optionalWith(S.String, { nullable: true })
}) {}
...
* Transaction type
*/
export class TransactionDtoType extends S.Literal("APPROVAL", "OPEN_POSITION", "CLOSE_POSITION", "UPDATE_LEVERAGE", "STOP_LOSS", "TAKE_PROFIT", "CANCEL_ORDER", "FUND", "WITHDRAW") {}
...
export class TokenControllerGetTokenPricesParams extends S.Struct({
  "X-API-KEY": S.optionalWith(S.String, { nullable: true })
}) {}

export class PriceRequestDto extends S.Class<PriceRequestDto>("PriceRequestDto")({
  "currency": S.String,
  "tokenList": S.Array(TokenDto)
}) {}

export class PriceResponseDto extends S.Class<PriceResponseDto>("PriceResponseDto")({
  
}) {}

export class StakeKitErrorDto extends S.Class<StakeKitErrorDto>("StakeKitErrorDto")({
  "message": S.String,
  "code": S.Number,
...
export class TokenControllerGetTokenBalancesParams extends S.Struct({
  "X-API-KEY": S.optionalWith(S.String, { nullable: true })
}) {}

export class CosmosAdditionalAddressesDto extends S.Class<CosmosAdditionalAddressesDto>("CosmosAdditionalAddressesDto")({
  /**
* Cosmos SDK public key encoded in base64 for secp256k1
*/
"cosmosPubKey": S.String.pipe(S.minLength(44), S.maxLength(44))
}) {}

export class BinanceAdditionalAddressesDto extends S.Class<BinanceAdditionalAddressesDto>("BinanceAdditionalAddressesDto")({
  "binanceBeaconAddress": S.String
}) {}

export class SolanaAdditionalAddressesDto extends S.Class<SolanaAdditionalAddressesDto>("SolanaAdditionalAddressesDto")({
  "stakeAccounts": S.Array(S.String),
  "lidoStakeAccounts": S.Array(S.String)
}) {}

export class TezosAdditionalAddressesDto extends S.Class<TezosAdditionalAddressesDto>("TezosAdditionalAddressesDto")({
  "tezosPubKey": S.String
}) {}

export class AvalancheCAdditionalAddressesDto extends S.Class<AvalancheCAdditionalAddressesDto>("AvalancheCAdditionalAddressesDto")({
  "cAddressBech": S.String,
  "pAddressBech": S.String
}) {}

export class AddressWithTokenDto extends S.Class<AddressWithTokenDto>("AddressWithTokenDto")({
  "address": S.String,
  "additionalAddresses": S.optionalWith(S.Union(CosmosAdditionalAddressesDto,
BinanceAdditionalAddressesDto,
SolanaAdditionalAddressesDto,
TezosAdditionalAddressesDto,
AvalancheCAdditionalAddressesDto), { nullable: true }),
  "network": Networks,
  "tokenAddress": S.optionalWith(S.String, { nullable: true })
}) {}

export class BalancesRequestDto extends S.Class<BalancesRequestDto>("BalancesRequestDto")({
  "addresses": S.Array(AddressWithTokenDto)
}) {}

export class BalanceResponseDto extends S.Class<BalanceResponseDto>("BalanceResponseDto")({
  "token": TokenDto,
  "amount": S.String,
  "availableYields": S.Array(S.String)
}) {}

export class TokenControllerGetTokenBalances200 extends S.Array(BalanceResponseDto) {}
...
export const make = (
  ...
  "TokenControllerGetTokenPrices": (options) => HttpClientRequest.post(`/v1/tokens/prices`).pipe(
    ...
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(PriceResponseDto),
      "400": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "401": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "404": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "408": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "412": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "429": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "500": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "501": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "503": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      orElse: unexpectedStatus
    }))
  ),
  "TokenControllerGetTokenBalances": (options) => HttpClientRequest.post(`/v1/tokens/balances`).pipe(
    ...
    HttpClientRequest.bodyUnsafeJson(options.payload),
    withResponse(HttpClientResponse.matchStatus({
      "2xx": decodeSuccess(TokenControllerGetTokenBalances200),
      "400": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "401": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "404": decodeError("StakeKitErrorDto", StakeKitErrorDto),
      "408": decodeError("StakeKitErrorDto", StakeKitErrorDto),
...
*/
readonly "TokenControllerGetTokenPrices": (options: { readonly params?: typeof TokenControllerGetTokenPricesParams.Encoded | undefined; readonly payload: typeof PriceRequestDto.Encoded }) => Effect.Effect<typeof PriceResponseDto.Type, HttpClientError.HttpClientError | ParseError | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type>>
  /**
* Returns the balances for specific addresses and token addresses
*/
readonly "TokenControllerGetTokenBalances": (options: { readonly params?: typeof TokenControllerGetTokenBalancesParams.Encoded | undefined; readonly payload: typeof BalancesRequestDto.Encoded }) => Effect.Effect<typeof TokenControllerGetTokenBalances200.Type, HttpClientError.HttpClientError | ParseError | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type> | SKClientError<"StakeKitErrorDto", typeof StakeKitErrorDto.Type>>
}
